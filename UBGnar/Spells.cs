...
namespace UBGnar
{
    class Spells
    {
        ...
        {
            QTiny = new Spell.Skillshot(SpellSlot.Q, 1050, SkillShotType.Linear, 250, 1250, 60, DamageType.Physical)
            {
            ...
            QMega = new Spell.Skillshot(SpellSlot.Q, 1050, SkillShotType.Linear, 250, 1200, 80, DamageType.Physical);
            WMega = new Spell.Skillshot(SpellSlot.W, 500, SkillShotType.Linear, 550, int.MaxValue, 80, DamageType.Physical)
            {
