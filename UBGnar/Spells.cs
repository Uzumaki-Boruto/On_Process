...
namespace UBGnar
{
    class Spells
    {
        ...
        {
            QTiny = new Spell.Skillshot(SpellSlot.Q, 1050, SkillShotType.Linear, 250, 1200, 60, DamageType.Physical)
            {
            ...
            WMega = new Spell.Skillshot(SpellSlot.W, 500, SkillShotType.Linear, 500, int.MaxValue, 80, DamageType.Physical)
            {
